...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  4 17:08:39 2024
...
class Digraph(object):
    ...
    def __str__(self):
        ...
        return result[:-1] # omit final newlinec
...
def buildCityGraph(graphType):
    ...
    for name in ('Boston', 'Province', 'New York', 'Chicago',
                     'Denver', 'Phoenix', 'Los Angles'): #Create 7 nodes
        g.addNode(Node(name))
...
def BSF(graph, start, end, toPrint = False):
...
def shortestPath(graph, start, end, toPrint = False):
    ...
    return BSF(graph, start, end, toPrint)
